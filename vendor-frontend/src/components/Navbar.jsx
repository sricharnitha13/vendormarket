...
// //           {/* Logo */}
// //           <Link to={user ? "/" : "/home"} onClick={close} className="flex-shrink-0 flex items-center gap-2">
// //             <span className="text-2xl">🛍️</span>
// //             <span className="text-xl font-black text-gray-900 tracking-tight">VendorMarket</span>
// //           </Link>
